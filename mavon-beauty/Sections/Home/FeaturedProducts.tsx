...
export default function FeaturedProducts() {
    ...
    const products = [
        {
            ...
            price: "From $280.00",
            image:
                "https://mavon-beauty.myshopify.com/cdn/shop/files/2_9a1087f8-855e-482a-9e51-923b3259a5b4.png?v=1686040892",
            hoverImage:
                "https://mavon-beauty.myshopify.com/cdn/shop/files/5.png?v=1686041880&width=1445",
        ...
        },
        {
            ...
            price: "$500.00",
            image:
                "https://mavon-beauty.myshopify.com/cdn/shop/files/18_2d9de600-36bb-4e80-a564-80a4e956a4f7.png?v=1686134750&width=1445",
            hoverImage:
                "https://mavon-beauty.myshopify.com/cdn/shop/files/1_fe5db9ee-9d94-428a-bcd4-e4070d55eea2_360x.png?v=1686034002",
        ...
        },
        {
            ...
            price: "From $200.00",
            image:
                "https://mavon-beauty.myshopify.com/cdn/shop/files/16_e8458d18-4c37-4ec0-bb3d-533d6a4a96cc.png?v=1686134750&width=1445",
            hoverImage:
                "https://mavon-beauty.myshopify.com/cdn/shop/files/p-3-hover.png?v=1685785108&width=533",
    ...
    return (
        <section
            className="py-16 -my-10 px-4 md:px-8 bg-white"
                                        ...
                                        <div className="relative mb-4 overflow-hidden bg-transparent ">
                                            <div className="relative h-112.5 w-full  mx-auto">
                                                <img
                                                    src={product.image}
                                                    alt={product.name}
                                                    className={`w-full h-full object-cover transition-opacity duration-300 ${hoveredProduct === currentSlide + index
                                                            ? "opacity-0"
                                                            : "opacity-100"
                                                        }`}
                                                />
                                                <img
                                                    ...
                                                    alt={product.name}
                                                    className={`w-full h-full object-cover absolute inset-0 transition-opacity duration-300 ${hoveredProduct === currentSlide + index
                                                            ? "opacity-100"
                                                            : "opacity-0"
                                                        }`}
                                                />
